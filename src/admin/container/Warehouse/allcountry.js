...
let districts = country_state_district.getDistrictsByStateId(State);
...
export default function AddWarehouse() {
    ...
    React.useEffect(() => {
        ...
        console.log("Available countries:", allCountries);
    }, []);
    ...
    const handleCountryChange = (e) => {
        ...
        console.log("States for selected country:", countryStates);
        setDistrict([]); // Clear districts when country changes
        setFieldValue('country', countryId);
        setFieldValue('state', ''); // Clear state selection
    ...
    const handleStateChange = (e) => {
        ...
        const stateDistricts = City.getCitiesOfState(values.country, stateId);
        setDistrict(stateDistricts);
        console.log("Districts for selected state:", stateDistricts);

        setFieldValue('state', stateId);
        setFieldValue('district', ''); // Clear district selection when state changes
    };
